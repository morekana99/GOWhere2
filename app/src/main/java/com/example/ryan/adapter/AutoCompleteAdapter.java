...
public class AutoCompleteAdapter extends BaseAdapter implements Filterable {
    ...
    private int defaultMode = MODE_CONTAINS;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.item_auto_compare, null);
            holder.tv = (TextView) convertView.findViewById(R.id.ss_title);
